...
- `python kmeans.py`: will display the original data, elbow diagram, kmeans clusters and will generate customer_segmentation.csv
- `python dt2.py`: will display decision tree generated by checking customer_segmentation.csv (using scikit)
- `python decision_tree.py`: will display decision tree generated by checking customer_segmentation.csv (coded from scratch)
<br>
